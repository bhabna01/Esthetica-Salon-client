    ...
    return (
        <div className='m-12'>
            <div className='shadow-lg mb-12'>
                <h1 className='font-semibold'>Difference between SQL and NoSQL</h1>
            ...
            <div className='shadow-lg mb-12'>
                <h1 className='font-semibold'>What is JWT, and how does it work?</h1>
            ...
            <div className='shadow-lg mb-12'>
                <h1 className='font-semibold' >What is the difference between javascript and NodeJS?</h1>
            ...
            <div className='shadow-lg mb-12'>
                <h1 className='font-semibold'>How does NodeJS handle multiple requests at the same time?</h1>
